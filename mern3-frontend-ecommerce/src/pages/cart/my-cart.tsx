...
function MyCart(){
    ...
    const subTotal = items.reduce((total:any,item:any)=>item.Product.productPrice * item.quantity + total,0)
    const totalQtyInCarts = items.reduce((total:any,item:any)=>item.quantity + total, 0)
